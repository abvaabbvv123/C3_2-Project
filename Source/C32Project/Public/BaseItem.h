...
UCLASS()
class C32PROJECT_API ABaseItem : public AActor, public IItemInterface
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item|Spining")
	bool bIsSpin = true;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item|Spining")
	FRotator Spining = FRotator(0.f, 90.0f, 0.f);
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item|Spining")
